...
inputs = merge({
  ...
  admin_appservice_name_primary = dependency.appServiceAdmin.outputs.primaryAdminAppServiceName
  admin_appservice_name_secondary = dependency.appServiceAdmin.outputs.secondaryAdminAppServiceName
  api_appservice_name_primary = dependency.appServiceAPI.outputs.primaryApiAppServiceName
  api_appservice_name_secondary = dependency.appServiceAPI.outputs.secondaryApiAppServiceName
