...
resource "azurerm_application_insights" "as-primary-appinsight" {
...
output "instrumentation_key" {
  value = azurerm_application_insights.as-primary-appinsight.instrumentation_key
}

output "app_id" {
  value = azurerm_application_insights.as-primary-appinsight.app_id
}